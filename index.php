        ...
        <div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 670, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'parallax': { 'type': 'scroll', 'origo': 'enterpoint', 'speed': 1000, 'levels': [2,3,4,5,6,7,8,9,12,50], 'disable_onmobile': 'on' }, 'navigation' : {'arrows': { 'enable': true }, 'bullets': {'enable': true, 'style': 'bullets-style-1', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
            <ul>
                <li data-transition="fade">
                    <img src="<?php echo home_url(); ?>/assets/porto/img/slides/slide-bg.jpg"  
                        alt=""
                    ...
                    <div class="tp-caption tp-resizeme"
                        ...
                        data-width="['auto']"
                        data-height="['auto']"
                        data-basealign="slide"><img src="<?php echo home_url(); ?>/assets/porto/img/slides/slide-devices.jpg" alt=""></div>
                    ...
                    <div class="tp-caption tp-resizeme"
                        ...
                        data-width="['auto']"
                        data-height="['auto']"
                        data-basealign="slide"><img src="<?php echo home_url(); ?>/assets/porto/img/slides/slide-laptop.jpg" alt=""></div>
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-7"
                        ...
                        data-width="['auto']"
                        data-height="['auto']"
                        data-basealign="slide"><img src="<?php echo home_url(); ?>/assets/porto/img/slides/slide-parallax-porto-symbol.png" alt=""></div>
                    ...
                    <div class="tp-caption"
                        ...
                        data-transform_idle="opacity:0.2;s:500;"><img src="<?php echo home_url(); ?>/assets/porto/img/slides/slide-title-border.png" alt=""></div>
                    ...
                    <div class="tp-caption text-color-light font-weight-normal"
                        ...
                        data-transform_in="y:[-50%];opacity:0;s:500;">BẠN CẦN ĐIỀU GÌ MỚI</div>
                    ...
                    <div class="tp-caption d-none d-md-block"
                        ...
                        data-y="center" data-voffset="['-33','-33','-33','-55']"><img src="<?php echo home_url(); ?>/assets/porto/img/slides/slide-blue-line.png" alt=""></div>
                    ...
                    <div class="tp-caption font-weight-extra-bold text-color-light negative-ls-2"
                        ...
                        data-lineheight="['55','55','55','95']">THIẾT KẾ WEBSITE?</div>
                    ...
                    <div class="tp-caption font-weight-light"
                        ...
                        style="color: #b5b5b5;">Hãy tham khảo dịch vụ thiết kế của chúng tôi</div>
                    
                </li>
                <li class="slide-overlay" data-transition="fade">
                    <img src="<?php echo home_url(); ?>/assets/porto/img/slides/slide-bg-2.jpg"  
                        alt=""
                        data-bgposition="center center" 
                        data-bgfit="cover" 
                        data-bgrepeat="no-repeat" 
                    ...
                    <div class="tp-caption text-color-light font-weight-normal"
                        ...
                        data-lineheight="['25','25','25','45']"
                        data-transform_in="y:[-50%];opacity:0;s:500;">LUÔN NỖ LỰC HẾT MÌNH ĐỂ TẠO RA</div>
                    ...
                    <div class="tp-caption font-weight-extra-bold text-color-light negative-ls-1"
                        ...
                        data-y="center"
                        data-fontsize="['50','50','50','90']"
                        data-lineheight="['55','55','55','95']">WEBSITE TỐT NHẤT</div>
                    ...
                    <div class="tp-caption font-weight-light ws-normal text-center"
                        ...
                        style="color: #b5b5b5;">Với hơn  <strong class="text-color-light">15 nằm</strong> kinh nghiệm thiết kế web, Và hàng trăm doanh nghiệm đã và đang sử dụng dịch vụ của chúng tôi.</div>
                    
                </li>
                <li class="slide-overlay slide-overlay-primary" data-transition="fade">
                    <img src="<?php echo home_url(); ?>/assets/porto/img/slides/slide-bg-6.jpg"  
                        alt=""
                        data-bgposition="center center" 
                        data-bgfit="cover" 
                        data-bgrepeat="no-repeat" 
                    ...
                    <div class="tp-caption text-color-light font-weight-normal"
                        ...
                        data-fontsize="['16','16','16','40']"
                        data-lineheight="['25','25','25','45']"
                        data-transform_in="y:[-50%];opacity:0;s:500;">CHÚNG TÔI TỰ HÀO VỚI</div>
                    ...
                    <div class="tp-caption font-weight-light text-color-light"
                        ...
                        data-fontsize="['18','18','18','40']"
                        data-lineheight="['26','26','26','45']">Là hệ thống bảo mật tốt nhất của chúng tôi</div>
    ...
    <div class="home-intro bg-primary" id="home-intro">
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <p>
                        Cách nhanh nhất để phát triển doanh nghiệp với <span class="highlighted-word">Công nghệ</span>
                        <span>Website là công cụ trực tiếp nhất để giao tiếp với khách hàng.</span>
                    </p>
                </div>
                <div class="col-lg-4">
                    <div class="get-started text-left text-lg-right">
                        <a href="#" class="btn btn-dark btn-lg text-3 font-weight-semibold px-4 py-3">Bắt đầu ngay</a>
        ...
        <div class="row text-center pt-3">
            <div class="col-md-10 mx-md-auto">
                <h1 class="word-rotator slide font-weight-bold text-8 mb-3 appear-animation" data-appear-animation="fadeInUpShorter">
                    <span>Chỉ cần bạn </span>
                    <span class="word-rotator-words bg-dark">
                        <b class="is-visible">nhìn</b>
                        <b>nghe</b>
                    </span>
                    <span> thấy thì chúng tôi đều có thể làm.</span>
                </h1>
                <p class="lead appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
                    Chúng tôi luôn có một lộ trình rõ ràng khi thiết kế website cho bạn.
                </p>
            </div>
        </div>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-lg-2 ml-lg-auto">
                        <div class="process-image">
                            <img src="<?php echo home_url(); ?>/assets/porto/img/home/home-concept-item-1.png" alt="" />
                            <strong>Thảo luận</strong>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="process-image process-image-on-middle">
                            <img src="<?php echo home_url(); ?>/assets/porto/img/home/home-concept-item-2.png" alt="" />
                            <strong>Thiết kế</strong>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="process-image">
                            <img src="<?php echo home_url(); ?>/assets/porto/img/home/home-concept-item-3.png" alt="" />
                    ...
                    <div class="col-lg-4 ml-lg-auto">
                        <div class="project-image">
                            <div id="fcSlideshow" class="fc-slideshow">
                                <ul class="fc-slides">
                                    <li><a href="portfolio-single-wide-slider.html"><img class="img-responsive" src="<?php echo home_url(); ?>/assets/porto/img/projects/project-home-1.jpg" alt="" /></a></li>
                                    <li><a href="portfolio-single-wide-slider.html"><img class="img-responsive" src="<?php echo home_url(); ?>/assets/porto/img/projects/project-home-2.jpg" alt="" /></a></li>
                                    <li><a href="portfolio-single-wide-slider.html"><img class="img-responsive" src="<?php echo home_url(); ?>/assets/porto/img/projects/project-home-3.jpg" alt="" /></a></li>
                                </ul>
                            </div>
                            <strong class="our-work">Bàn giao</strong>
                        </div>
                    </div>
                </div>
    ...
    <div class="container mb-5 pb-4">
        ...
        <div class="row text-center mt-5">
            <div class="owl-carousel owl-theme carousel-center-active-item" data-plugin-options="{'responsive': {'0': {'items': 1}, '476': {'items': 1}, '768': {'items': 5}, '992': {'items': 7}, '1200': {'items': 7}}, 'autoplay': true, 'autoplayTimeout': 3000, 'dots': false}">
                <div>
                    <img class="img-fluid" src="<?php echo home_url(); ?>/assets/porto/img/logos/logo-1.png" alt="">
                </div>
                <div>
                    <img class="img-fluid" src="<?php echo home_url(); ?>/assets/porto/img/logos/logo-2.png" alt="">
                </div>
                <div>
                    <img class="img-fluid" src="<?php echo home_url(); ?>/assets/porto/img/logos/logo-3.png" alt="">
                </div>
                <div>
                    <img class="img-fluid" src="<?php echo home_url(); ?>/assets/porto/img/logos/logo-4.png" alt="">
                </div>
                <div>
                    <img class="img-fluid" src="<?php echo home_url(); ?>/assets/porto/img/logos/logo-5.png" alt="">
                </div>
                <div>
                    <img class="img-fluid" src="<?php echo home_url(); ?>/assets/porto/img/logos/logo-6.png" alt="">
                </div>
                <div>
                    <img class="img-fluid" src="<?php echo home_url(); ?>/assets/porto/img/logos/logo-4.png" alt="">
                </div>
                                        ...
                                        <div class="testimonial testimonial-primary">
                                            ...
                                            <div class="testimonial-author">
                                                <div class="testimonial-author-thumbnail">
                                                    <img src="<?php echo home_url(); ?>/assets/porto/img/clients/client-1.jpg" class="rounded-circle" alt="">
                                                </div>
